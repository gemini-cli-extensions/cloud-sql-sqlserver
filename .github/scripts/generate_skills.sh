...
# The skill name is automatically generated as "cloud-sql-sqlserver-<toolset>"
SKILLS=(
  "admin"
...
RAW_URL="https://raw.githubusercontent.com/googleapis/mcp-toolbox/v${VERSION}/internal/prebuiltconfigs/tools/cloud-sql-mssql.yaml"
...
generate_skill() {
  local TOOLSET="$1"
  local SKILL_DESC="$2"
  local SKILL_NAME="cloud-sql-sqlserver-$TOOLSET"

  echo "Generating skill: $SKILL_NAME..."

  npx "@toolbox-sdk/server@${VERSION}" --prebuilt cloud-sql-mssql skills-generate \
    --name "$SKILL_NAME" \
